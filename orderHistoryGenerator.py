...
data = []
num_orders = 2000 # change me for more orders

end_date = datetime.today()
start_date = end_date - timedelta(weeks=52) # past 52 weeks

# generate random dates and sort from startdate to enddate
...
for order_date in order_dates:
    ...
    # we do not accept blowjobs as payment
    ...
    for _, menu_item in chosen_items.iterrows():
        # weight again for quantity
        quantity = random.choices([1, 2], weights=[95, 5], k=1)[0]
